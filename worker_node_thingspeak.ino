...
unsigned long myChannelNumber = 2347129;
const char * myWriteAPIKey = "RNE409HPKWIXOK5W";
...
const char* ssid = "HP";   // your network SSID (name) 
...
void loop()
{
  ...
  if (checkForBeat(irValue) == true)
  {
    ...
    int x = ThingSpeak.writeField(myChannelNumber, 1, beatAvg+50, myWriteAPIKey);
    int y = ThingSpeak.writeField(myChannelNumber, 2, spo2 , myWriteAPIKey);
    int z = ThingSpeak.writeField(myChannelNumber, 3, temperatureF+8 , myWriteAPIKey);
